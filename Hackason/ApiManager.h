...
- (void)connect:(NSString *)apiName postData:(NSDictionary *)postData complete:(void (^)(NSArray *result))callbackComplete error:(void (^)(NSDictionary *result))callbackError;
